...
export default function ImportDialog(props: Props): JSX.Element {
  ...
  async function importFiles(files: File[]) {
    ...
    try {
      ...
      const errorMsg = error instanceof Error ? `error-import-failed: ${error.message}` : "error-import-failed";
  ...
  return (
    <BaseDialog isOpen={isOpen} onClose={closeModal} title={t("import")}>
      <div className="mt-2">
        ...
        <div className="border-2 border-dashed border-gray-300 border-opacity-100 rounded-lg">
          <div {...getRootProps({ className: "dropzone" })}>
            ...
            <div className="py-4 w-min mx-auto">
              <div className="mb-4 whitespace-nowrap">{t("import-dialog-drag-and-drop")}</div>
